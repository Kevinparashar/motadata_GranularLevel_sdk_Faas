...
from typing import Dict, List, Optional, Union, Callable, Any, TypeVar
...
def ensure_type(value: Any, expected_type: type[T], error_message: str = "Type mismatch") -> T:
    ...
    if not isinstance(value, expected_type):
        raise TypeError(f"{error_message}: expected {expected_type.__name__}, got {type(value).__name__}")
    return value
