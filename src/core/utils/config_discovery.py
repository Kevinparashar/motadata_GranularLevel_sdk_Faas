    ...
    return {
        ...
        "optional": {
            ...
            "default_model": {
                ...
                "example": "gpt-4",
                "default": "gpt-4",
                "valid_options": ["gpt-4", "gpt-3.5-turbo", "claude-3-opus", "claude-3-sonnet", "gemini-pro"]
            },
            "timeout": {
                "type": "float",
...
def print_config_options(component_name: str) -> None:
    ...
    if "example" in options and options["example"]:
...
def discover_config(component_name: str, partial_config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    """
    ...
    """
    from .config_validator import ConfigValidator, ConfigHelper
