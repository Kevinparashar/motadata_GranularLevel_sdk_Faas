...
class UseCaseModelTemplate(BaseMLModel):
    ...
    def train(
        ...
        **kwargs,
        ...
        return {"model_id": self.model_id, "metrics": {}, "status": "completed"}
    ...
    def predict(self, input_data: Any, **kwargs) -> Any:
        ...
        # TODO: SDK-TEMPLATE-002 - Implement prediction logic for your use case  # noqa: FIX002, S1135
    ...
    def evaluate(self, test_data: Any, **kwargs) -> Dict[str, Any]:
        ...
        # TODO: SDK-TEMPLATE-003 - Implement evaluation logic for your use case  # noqa: FIX002, S1135
