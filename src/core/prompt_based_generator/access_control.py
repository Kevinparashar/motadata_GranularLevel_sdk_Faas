...
class AccessControl:
    ...
    def grant_permission(
        ...
        if (
            permission
            not in self._permissions[tenant_id][user_id][resource_type.value][resource_id]
        ):
            self._permissions[tenant_id][user_id][resource_type.value][resource_id].append(
                permission
            )
    ...
    def revoke_permission(
        ...
        if permission in self._permissions[tenant_id][user_id][resource_type.value][resource_id]:
            self._permissions[tenant_id][user_id][resource_type.value][resource_id].remove(
                permission
            )
    ...
    def get_user_permissions(
        self, tenant_id: str, user_id: str, resource_type: Optional[ResourceType] = None
