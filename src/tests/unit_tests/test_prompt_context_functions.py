...
class TestConvenienceFunctions:
    ...
    def prompt_manager(self):
        ...
        manager.add_template(
            name="test_template", template="Hello {name}, you are {age} years old.", version="1.0"
        )
        return manager
    ...
    def test_build_context(self, prompt_manager):
        ...
        context = build_context(
            manager=prompt_manager, new_message="What is AI?", history=history, include_history=True
        )
    ...
    def test_truncate_to_fit(self, prompt_manager):
        ...
        truncated = truncate_to_fit(manager=prompt_manager, text=long_text, max_tokens=100)
    ...
    def test_truncate_to_fit_short_text(self, prompt_manager):
        ...
        truncated = truncate_to_fit(manager=prompt_manager, text=short_text, max_tokens=100)
